# ck_maptier from https://github.com/Sayt123/SurfZones/blob/main/Zones/REPLACE_ALL_maptier.sql
...
ck_maptier = [
    ...
    ['surf_aether', 2, 3500, 1, 1, 1, 'Scaz.zaf'],
    ...
    ['surf_akai_final', 1, 3500, 1, 1, 1, 'akai'],
    ...
    ['surf_amantiss', 4, 3500, 1, 1, 1, 'Mallow'],
    ['surf_amaranthine', 2, 3500, 1, 1, 1, 'Kuiq'],
    ['surf_amaro', 6, 3500, 1, 1, 1, 'Flaudgin'],
    ...
    ['surf_android_ksf', 5, 3500, 1, 1, 1, 'Xtra_Festive'],
    ['surf_andromeda', 1, 4500, 1, 1, 1, 'Syncronyze'],
    ['surf_and_destroy_fix', 1, 3500, 1, 1, 1, 'ZaLoS'],
    ['surf_angst', 4, 3500, 1, 1, 1, 'Proxychains'],
    ['surf_animals_ksf', 3, 3500, 1, 1, 1, 'Collaboration'],
    ...
    ['surf_anubis_ksf', 7, 3500, 1, 1, 1, 'Sneakyyy'],
    ...
    ['surf_aqua', 2, 3500, 1, 1, 1, 'xRyanNitro'],
    ...
    ['surf_aux_fix', 5, 3500, 1, 1, 1, 'twistedVoid'],
    ...
    ['surf_beginner_hell', 4, 3500, 1, 1, 1, 'dotone'],
    ...
    ['surf_beverages_remix', 2, 3500, 1, 1, 1, 'Sid'],
    ...
    ['surf_bullet', 6, 3500, 1, 1, 1, 'Collaboration'],
    ...
    ['surf_chasm', 4, 3500, 1, 1, 1, 'SID'],
    ['surf_chateau_fix', 4, 3500, 1, 1, 1, 'Hesuka'],
    ['surf_chill', 1, 3500, 1, 1, 1, 'Dimitri'],
    ['surf_christmas2', 4, 3500, 1, 1, 1, 'Collaboration'],
    ['surf_christmas', 3, 3500, 1, 1, 1, 'Collaboration'],
    ...
    ['surf_core_refix', 5, 3500, 1, 1, 1, 'Collaboration'],
    ...
    ['surf_crzyfrog_reloaded', 1, 3500, 1, 1, 1, 'JackTheStripper'],
    ...
    ['surf_cyberwave', 2, 3500, 1, 1, 1, 'Mr. Cow'],
    ...
    ['surf_delight', 2, 3500, 1, 1, 1, 'Aqresiv3'],
    ...
    ['surf_drifting', 4, 10000, 1, 1, 1, 'murglegurgle'],
    ['surf_driftless', 3, 3500, 1, 1, 1, 'murglegurgle'],
    ['surf_drift', 5, 5000, 1, 1, 1, 'murglegurgle'],
    ['surf_drugs', 3, 3500, 1, 1, 1, 'Bonjorno7'],
    ...
    ['surf_eclipse', 2, 3500, 1, 1, 1, 'Paper-Cut'],
    ...
    ['surf_egypt', 1, 3500, 1, 1, 1, 'Umg_'],
    ['surf_eldritch', 2, 3500, 1, 1, 1, 'a-ha!'],
    ['surf_elements_beta3', 3, 3500, 1, 1, 1, 'Ryan S'],
    ...
    ['surf_enlightened_ksf', 1, 3500, 1, 1, 1, 'Benchmarked'],
    ...
    ['surf_fiellu_ksf', 3, 3500, 1, 1, 1, 'Kahvo'],
    ...
    ['surf_flipv2', 2, 3500, 1, 1, 1, 'Flip'],
    ['surf_flixy', 2, 3500, 1, 1, 1, 'N/A'],
    ['surf_flow_ksf', 2, 3500, 1, 1, 1, 'Koga73'],
    ...
    ['surf_forbidden_tomb4', 4, 3500, 1, 1, 1, 'Rapsodia'],
    ...
    ['surf_fortress_ksf', 4, 3500, 1, 1, 1, 'Collaboration'],
    ['surf_fortum_fix', 2, 3500, 1, 1, 1, 'Collaboration'],
    ...
    ['surf_frey_remake', 2, 3500, 1, 1, 1, 'KappaEliitti'],
    ...
    ['surf_fruits', 2, 3500, 1, 1, 1, 'Collaboration'],
    ...
    ['surf_funhouse_v1', 1, 3500, 1, 1, 1, '[UDel]Steve'],
    ...
    ['surf_garden', 1, 3500, 1, 1, 1, 'Big Sid'],
    ['surf_garden_h', 5, 3500, 1, 1, 1, 'Big Sid'],
    ...
    ['surf_halloween_fix', 4, 3500, 1, 1, 1, 'Collaboration'],
    ['surf_halloween_tf2', 2, 3500, 1, 1, 1, 'Egan'],
    ...
    ['surf_harmony_fix', 2, 3500, 1, 1, 1, 'PrisonNightmare'],
    ...
    ['surf_holiday', 2, 3500, 1, 1, 1, 'iNooVa'],
    ...
    ['surf_interference', 2, 10000, 1, 1, 1, 'NvC_DmN_CH'],
    ['surf_intothewild', 2, 3500, 1, 1, 1, 'Koga73'],
    ['surf_intra', 4, 3500, 1, 1, 1, 'Maz64'],
    ['surf_in_space', 2, 3500, 1, 1, 1, 'KappaEliitti'],
    ...
    ['surf_jail', 1, 10000, 1, 1, 1, 'Murglegurgle'],
    ...
    ['surf_kitsune2', 3, 3500, 1, 1, 1, 'Arblarg'],
    ...
    ['surf_lax', 4, 3500, 1, 1, 1, 'Krealington'],
    ...
    ['surf_limbo', 4, 3500, 1, 1, 1, 'murglegurgle'],
    ...
    ['surf_lore', 2, 3500, 1, 1, 1, 'Target Practice'],
    ...
    ['surf_mesa_aether', 3, 3500, 1, 1, 1, 'Arblarg'],
    ['surf_mesa_fixed', 1, 3500, 1, 1, 1, 'N/A'],
    ['surf_mesa_mine', 2, 3500, 1, 1, 1, 'Arblarg'],
    ['surf_mesa_revo', 1, 3500, 1, 1, 1, 'Arblarg'],
    ...
    ['surf_nascent', 4, 3500, 1, 1, 1, 'Whimsy'],
    ...
    ['surf_network2008_final', 2, 3500, 1, 1, 1, 'Ryan S'],
    ['surf_network_2009', 3, 3500, 1, 1, 1, 'Ryan S'],
    ...
    ['surf_not_so_zen', 6, 10000, 1, 1, 1, 'Mr.25'],
    ...
    ['surf_orthodox', 2, 3500, 1, 1, 1, 'ArcticPanda'],
    ...
    ['surf_rookie', 1, 3500, 1, 1, 1, 'Kiiru'],
    ...
    ['surf_royal_fix', 6, 3500, 1, 1, 1, 'Synx'],
    ...
    ['surf_saturday', 2, 3500, 1, 1, 1, 'iamsupaman'],
    ...
    ['surf_semesterbreak', 2, 3500, 1, 1, 1, 'Sam'],
    ...
    ['surf_simpsons_source', 1, 3500, 1, 1, 1, 'The-Goose'],
    ...
    ['surf_sinsane2', 7, 3500, 1, 1, 1, 'Not_a_zombie'],
    ['surf_sinsane_ez', 3, 3500, 1, 1, 1, 'Mbopferkuch'],
    ['surf_sinsane', 6, 3500, 1, 1, 1, 'b0at'],
    ...
    ['surf_starfire', 2, 3500, 1, 1, 1, 'Ver'],
    ['surf_stargaze', 3, 3500, 1, 1, 1, 'Ver'],
    ...
    ['surf_summer_ksf', 2, 3500, 1, 1, 1, 'Collaboration'],
    ...
    ['surf_torque2', 3, 3500, 1, 1, 1, 'Sangre'],
    ...
    ['surf_treasurehunt', 1, 3500, 1, 1, 1, 'The Frying Dutch Pan'],
    ...
    ['surf_tuscany', 2, 3500, 1, 1, 1, 'Exxe'],
    ['surf_tuxedo', 4, 3500, 1, 1, 1, 'Caksoso'],
    ...
    ['surf_underworld', 4, 3500, 1, 1, 1, 'Billy'],
    ...
    ['surf_vgaport', 3, 3500, 1, 1, 1, 'Flip, YajiGod, Unknown'],
    ...
    ['surf_water_run_ksf', 1, 3500, 1, 1, 1, 'Mario & Nutz'],
    ...
    ['surf_whoknows_ksf', 4, 3500, 1, 1, 1, 'Malt'],
    ...
    ['surf_wood', 1, 3500, 1, 1, 1, 'Enjooi & System Error'],
    ...
    ['surf_zeonine', 4, 3500, 1, 1, 1, 'Collaboration'],
    ['surf_zion', 3, 3500, 1, 1, 1, 'N/A'],
    ['surf_zlash', 1, 3500, 1, 1, 1, 'shalz'],
    ['surf_zoomathon', 1, 3500, 1, 1, 1, 'Sid'],
    ['surf_zoomboys', 3, 5000, 1, 1, 1, 'Sid'],
